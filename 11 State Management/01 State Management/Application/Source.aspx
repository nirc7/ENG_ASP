...
<body>
   ...
   <div>
    ...
    <asp:Button runat="server" ID="btn" Text="application" onclick="btn_Click"/><br />
    <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/application/Target.aspx">Taget.aspx</asp:LinkButton>
