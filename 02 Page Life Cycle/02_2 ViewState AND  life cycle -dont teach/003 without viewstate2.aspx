...
<body>
    ...
    <div>
        ...
        <br />  
        <asp:TextBox runat="server" ID="result" EnableViewState="false">your result is...</asp:TextBox>
        <asp:Label runat="server" ID="lblRes" EnableViewState="false" >your result is...</asp:Label>
        <asp:Button runat="server" ID="btnRes" Text="start"  EnableViewState="false" />
